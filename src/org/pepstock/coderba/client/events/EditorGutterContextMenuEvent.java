 ...
 */
public final class EditorGutterContextMenuEvent extends AbstractEditorWithNativeEvent<EditorGutterContextMenuEventHandler> {

	/**
	 * Event type
	 */
	public static final Type<EditorGutterContextMenuEventHandler> TYPE = new Type<>();
	/**
	 ...
	 */
	@Override
	public Type<EditorGutterContextMenuEventHandler> getAssociatedType() {
		return TYPE;
	}
	 ...
	 */
	@Override
	protected void dispatch(EditorGutterContextMenuEventHandler handler) {
		handler.onGutterContextMenu(this);
	}

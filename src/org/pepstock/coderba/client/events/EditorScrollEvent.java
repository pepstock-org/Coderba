 ...
 */
public final class EditorScrollEvent extends AbstractEditorEvent<EditorScrollEventHandler> {
	 ...
	 */
	@Override
	public Type<EditorScrollEventHandler> getAssociatedType() {
		return TYPE;
	}
	 ...
	 */
	@Override
	protected void dispatch(EditorScrollEventHandler handler) {

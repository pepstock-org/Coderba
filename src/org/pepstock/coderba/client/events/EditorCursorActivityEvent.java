 ...
 */
public final class EditorCursorActivityEvent extends AbstractEditorEvent<EditorCursorActivityEventHandler> {

	/**
	 * Event type
	 */
	public static final Type<EditorCursorActivityEventHandler> TYPE = new Type<>();
	/**
	 ...
	 */
	public EditorCursorActivityEvent(EditorArea editorArea) {
	 ...
	 */
	@Override
	public Type<EditorCursorActivityEventHandler> getAssociatedType() {
		return TYPE;
	}
	 ...
	 */
	@Override
	protected void dispatch(EditorCursorActivityEventHandler handler) {

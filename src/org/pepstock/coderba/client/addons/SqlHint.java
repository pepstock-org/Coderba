...
/**
 * Is the "sql-hint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class SqlHint extends AddOn {
	// name of editor addon
	private static final String NAME = "sql-hint";

	/**
	 * Instance of editor addon.
	 */
	public static final SqlHint ADDON = new SqlHint();
	...
	private SqlHint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.sqlHint()));
	}

...
/**
 * Is the "comment" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Comment extends AddOn {
	 ...
	 */
	public static final Comment ADDON = new Comment();
	...
	private Comment() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.comment()));
	}

...
/**
 * Is the "trailingspace" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Trailingspace extends AddOn {
	// name of editor addon
	private static final String NAME = "trailingspace";

	/**
	 * Instance of editor addon.
	 */
	public static final Trailingspace ADDON = new Trailingspace();
	...
	private Trailingspace() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.trailingspace()));
	}

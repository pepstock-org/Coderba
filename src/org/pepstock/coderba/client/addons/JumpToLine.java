...
/**
 * Is the "jump-to-line" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class JumpToLine extends AddOn {
	 ...
	 */
	public static final JumpToLine ADDON = new JumpToLine();

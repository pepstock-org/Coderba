...
/**
 * Is the "brace-fold" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class BraceFold extends AddOn {
	// name of editor addon
	private static final String NAME = "brace-fold";

	/**
	 * Instance of editor addon.
	 */
	public static final BraceFold ADDON = new BraceFold();
	...
	private BraceFold() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.braceFold()));
	}

...
/**
 * Is the "merge" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Merge extends AddOn {
	 ...
	 */
	public static final Merge ADDON = new Merge();
	...
	private Merge() {
		...
		super(NAME);
		getResources().add(new StyleResource(AddOnResources.INSTANCE.mergeCss()));
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.merge()));
	}

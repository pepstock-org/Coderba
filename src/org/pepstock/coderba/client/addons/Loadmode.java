...
/**
 * Is the "loadmode" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Loadmode extends AddOn {
	// name of editor addon
	private static final String NAME = "loadmode";

	/**
	 * Instance of editor addon.
	 */
	public static final Loadmode ADDON = new Loadmode();
	...
	private Loadmode() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.loadmode()));
	}

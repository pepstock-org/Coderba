...
/**
 * Is the "match-highlighter" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class MatchHighlighter extends AddOn {
	 ...
	 */
	public static final MatchHighlighter ADDON = new MatchHighlighter();

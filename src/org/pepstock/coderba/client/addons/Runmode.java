...
/**
 * Is the "runmode" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Runmode extends AddOn {
	// name of editor addon
	private static final String NAME = "runmode";

	/**
	 * Instance of editor addon.
	 */
	public static final Runmode ADDON = new Runmode();
	...
	private Runmode() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.runmode()));
	}

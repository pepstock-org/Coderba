...
/**
 * Is the "lint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class AddOnLint extends AddOn {
	 ...
	 */
	public static final AddOnLint INSTANCE = new AddOnLint();
	...
	private AddOnLint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.lint()));
		getResources().add(new StyleResource(AddOnResources.INSTANCE.lintCss()));
	}

...
/**
 * Is the "closebrackets" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Closebrackets extends AddOn {
	 ...
	 */
	public static final Closebrackets ADDON = new Closebrackets();

...
/**
 * Is the "multiplex" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Multiplex extends AddOn {
	// name of editor addon
	private static final String NAME = "multiplex";

	/**
	 * Instance of editor addon.
	 */
	public static final Multiplex ADDON = new Multiplex();
	...
	private Multiplex() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.multiplex()));
	}

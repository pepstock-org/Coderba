...
/**
 * Is the "hardwrap" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Hardwrap extends AddOn {
	// name of editor addon
	private static final String NAME = "hardwrap";

	/**
	 * Instance of editor addon.
	 */
	public static final Hardwrap ADDON = new Hardwrap();
	...
	private Hardwrap() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.hardwrap()));
	}

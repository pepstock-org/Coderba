...
/**
 * Is the "matchtags" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Matchtags extends AddOn {
	// name of editor addon
	private static final String NAME = "matchtags";

	/**
	 * Instance of editor addon.
	 */
	public static final Matchtags ADDON = new Matchtags();
	...
	private Matchtags() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.matchtags()));
	}

...
/**
 * Is the "yaml-lint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class YamlLint extends AddOn {
	// name of editor addon
	private static final String NAME = "yaml-lint";

	/**
	 * Instance of editor addon.
	 */
	public static final YamlLint ADDON = new YamlLint();
	...
	private YamlLint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.yamlLint()));
	}

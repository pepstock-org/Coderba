...
/**
 * Is the "closetag" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Closetag extends AddOn {
	// name of editor addon
	private static final String NAME = "closetag";

	/**
	 * Instance of editor addon.
	 */
	public static final Closetag ADDON = new Closetag();
	...
	private Closetag() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.closetag()));
	}

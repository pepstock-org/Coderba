...
/**
 * Is the "foldcode" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Foldcode extends AddOn {
	// name of editor addon
	private static final String NAME = "foldcode";

	/**
	 * Instance of editor addon.
	 */
	public static final Foldcode ADDON = new Foldcode();
	...
	private Foldcode() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.foldcode()));
	}

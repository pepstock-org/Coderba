...
/**
 * Is the "tern" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Tern extends AddOn {
	// name of editor addon
	private static final String NAME = "tern";

	/**
	 * Instance of editor addon.
	 */
	public static final Tern ADDON = new Tern();
	...
	private Tern() {
		...
		super(NAME);
		getResources().add(new StyleResource(AddOnResources.INSTANCE.ternCss()));
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.tern()));
	}

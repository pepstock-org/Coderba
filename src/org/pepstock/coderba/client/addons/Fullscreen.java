 ...
 *
 */
public final class Fullscreen extends AddOn {
	// name of editor addon
	private static final String NAME = "fullscreen";

	/**
	 * Instance of editor addon.
	 */
	public static final Fullscreen ADDON = new Fullscreen();
	...
	private Fullscreen() {
		...
		super(NAME);
		getResources().add(new StyleResource(AddOnResources.INSTANCE.fullscreenCss()));
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.fullscreen()));
	}

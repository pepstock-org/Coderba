...
/**
 * Is the "annotatescrollbar" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Annotatescrollbar extends AddOn {
	 ...
	 */
	public static final Annotatescrollbar ADDON = new Annotatescrollbar();

	/**
	 * To avoid any instantiation
	 */
	private Annotatescrollbar() {

...
/**
 * Is the "json-lint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class JsonLint extends AddOn {
	// name of editor addon
	private static final String NAME = "json-lint";

	/**
	 * Instance of editor addon.
	 */
	public static final JsonLint ADDON = new JsonLint();
	...
	private JsonLint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.jsonLint()));
	}

...
/**
 * Is the "scrollpastend" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Scrollpastend extends AddOn {
	// name of editor addon
	private static final String NAME = "scrollpastend";

	/**
	 * Instance of editor addon.
	 */
	public static final Scrollpastend ADDON = new Scrollpastend();
	...
	private Scrollpastend() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.scrollpastend()));
	}

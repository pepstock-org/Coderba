...
/**
 * Is the "xml-fold" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class XmlFold extends AddOn {
	// name of editor addon
	private static final String NAME = "xml-fold";

	/**
	 * Instance of editor addon.
	 */
	public static final XmlFold ADDON = new XmlFold();
	...
	private XmlFold() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.xmlFold()));
	}

...
/**
 * Is the "simple" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Simple extends AddOn {
	 ...
	 */
	public static final Simple ADDON = new Simple();
	...
	private Simple() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.simple()));
	}

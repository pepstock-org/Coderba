...
/**
 * Is the "runmode.node" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Runmodenode extends AddOn {
	 ...
	 */
	public static final Runmodenode ADDON = new Runmodenode();

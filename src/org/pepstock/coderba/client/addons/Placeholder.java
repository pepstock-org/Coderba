...
/**
 * Is the "placeholder" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Placeholder extends AddOn {
	 ...
	 */
	public static final Placeholder ADDON = new Placeholder();
	...
	private Placeholder() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.placeholder()));
	}

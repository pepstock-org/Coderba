...
/**
 * Is the "searchcursor" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Searchcursor extends AddOn {
	// name of editor addon
	private static final String NAME = "searchcursor";

	/**
	 * Instance of editor addon.
	 */
	public static final Searchcursor ADDON = new Searchcursor();
	...
	private Searchcursor() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.searchcursor()));
	}

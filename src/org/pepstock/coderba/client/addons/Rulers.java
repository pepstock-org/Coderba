...
/**
 * Is the "rulers" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Rulers extends AddOn {
	// name of editor addon
	private static final String NAME = "rulers";

	/**
	 * Instance of editor addon.
	 */
	public static final Rulers ADDON = new Rulers();
	...
	private Rulers() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.rulers()));
	}

...
/**
 * Is the "css-lint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class CssLint extends AddOn {
	 ...
	 */
	public static final CssLint ADDON = new CssLint();
	...
	private CssLint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.cssLint()));
	}

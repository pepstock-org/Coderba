...
/**
 * Is the "xml-hint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class XmlHint extends AddOn {
	// name of editor addon
	private static final String NAME = "xml-hint";

	/**
	 * Instance of editor addon.
	 */
	public static final XmlHint ADDON = new XmlHint();
	...
	private XmlHint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.xmlHint()));
	}

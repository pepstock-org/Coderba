...
/**
 * Is the "css-hint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class CssHint extends AddOn {
	// name of editor addon
	private static final String NAME = "css-hint";

	/**
	 * Instance of editor addon.
	 */
	public static final CssHint ADDON = new CssHint();
	...
	private CssHint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.cssHint()));
	}

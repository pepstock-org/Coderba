...
/**
 * Is the "overlay" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Overlay extends AddOn {
	 ...
	 */
	public static final Overlay ADDON = new Overlay();
	...
	private Overlay() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.overlay()));
	}

 ...
 *
 */
public final class Colorize extends AddOn {
	// name of editor addon
	private static final String NAME = "colorize";

	/**
	 * Instance of editor addon.
	 */
	public static final Colorize ADDON = new Colorize();
	...
	private Colorize() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.colorize()));
	}

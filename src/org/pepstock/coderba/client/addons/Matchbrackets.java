...
/**
 * Is the "matchbrackets" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Matchbrackets extends AddOn {
	// name of editor addon
	private static final String NAME = "matchbrackets";

	/**
	 * Instance of editor addon.
	 */
	public static final Matchbrackets ADDON = new Matchbrackets();
	...
	private Matchbrackets() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.matchbrackets()));
	}

...
/**
 * Is the "html-lint" addon to enable this capability int the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class HtmlLint extends AddOn {
	// name of editor addon
	private static final String NAME = "html-lint";

	/**
	 * Instance of editor addon.
	 */
	public static final HtmlLint ADDON = new HtmlLint();
	...
	private HtmlLint() {
		...
		super(NAME);
		getResources().add(new ScriptResource(AddOnResources.INSTANCE.htmlLint()));
	}

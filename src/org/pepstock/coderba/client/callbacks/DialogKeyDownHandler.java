...
/**
 * Related to {@link AddOnDialog}, defines the dialog callback that will be called whenever "keydown" event fires in the
 * dialog's input.<br>
 ...
 *
 */
public interface DialogKeyDownHandler {

	/**
	 * It will be called whenever "keydown" event fires in the dialog's input.<br>
	 * If your callback returns <code>true</code>, the dialog will not do any further processing of the event.
	 * 
	 * @param dialog dialog instance
	 * @param event "keydown" native event instance
	 * @param value value of text input element
	 * @return <code>true</code>, the dialog will not do any further processing of the event
	 */
	boolean onKeyDown(Dialog dialog, NativeEvent event, String value);

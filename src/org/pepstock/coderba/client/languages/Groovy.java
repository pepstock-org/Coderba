...
/**
 * Is the "Groovy" language entity in order to abe able to set to the editor.
 * 
...
public class Groovy implements Language {
	...
	private final String name = "text/x-groovy";

	private final String longName = "Groovy";

	private final Mode mode = org.pepstock.coderba.client.modes.Groovy.MODE;

	public static final Groovy LANGUAGE = new Groovy();

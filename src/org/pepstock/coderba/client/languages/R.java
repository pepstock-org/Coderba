 ...
 *
 */
public class R implements Language {

	private final String name = "text/x-rsrc";

	private final String longName = "R";

	private final Mode mode = org.pepstock.coderba.client.modes.R.MODE;

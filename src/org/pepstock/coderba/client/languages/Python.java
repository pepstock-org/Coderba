...
/**
 * Is the "Python" language entity in order to abe able to set to the editor.
 * 
...
public class Python implements Language {
	...
	private final String name = "text/x-python";

	private final String longName = "Python";

	private final Mode mode = org.pepstock.coderba.client.modes.Python.MODE;

	public static final Python LANGUAGE = new Python();

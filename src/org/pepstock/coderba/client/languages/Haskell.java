...
/**
 * Is the "Haskell" language entity in order to abe able to set to the editor.
 * 
...
public class Haskell implements Language {
	...
	private final String name = "text/x-haskell";

	private final String longName = "Haskell";

	private final Mode mode = org.pepstock.coderba.client.modes.Haskell.MODE;

	public static final Haskell LANGUAGE = new Haskell();

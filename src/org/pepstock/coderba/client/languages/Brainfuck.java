...
/**
 * Is the "Brainfuck" language entity in order to abe able to set to the editor.
 * 
...
public class Brainfuck implements Language {
	...
	private final String name = "text/x-brainfuck";

	private final String longName = "Brainfuck";

	private final Mode mode = org.pepstock.coderba.client.modes.Brainfuck.MODE;

	public static final Brainfuck LANGUAGE = new Brainfuck();

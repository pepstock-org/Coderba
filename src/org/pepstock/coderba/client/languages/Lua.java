...
/**
 * Is the "Lua" language entity in order to abe able to set to the editor.
 * 
...
public class Lua implements Language {
	...
	private final String name = "text/x-lua";

	private final String longName = "Lua";

	private final Mode mode = org.pepstock.coderba.client.modes.Lua.MODE;

	public static final Lua LANGUAGE = new Lua();

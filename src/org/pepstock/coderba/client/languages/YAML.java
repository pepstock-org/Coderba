...
/**
 * Is the "YAML" language entity in order to abe able to set to the editor.
 * 
...
public class YAML implements Language {
	...
	private final String name = "text/x-yaml";

	private final String longName = "YAML";

	private final Mode mode = org.pepstock.coderba.client.modes.Yaml.MODE;

	public static final YAML LANGUAGE = new YAML();

 ...
 *
 */
public class Z80 implements Language {

	private final String name = "text/x-z80";

	private final String longName = "Z80";

	private final Mode mode = org.pepstock.coderba.client.modes.Z80.MODE;

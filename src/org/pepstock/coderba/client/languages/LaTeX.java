...
/**
 * Is the "LaTeX" language entity in order to abe able to set to the editor.
 * 
...
public class LaTeX implements Language {
	...
	private final String name = "text/x-latex";

	private final String longName = "LaTeX";

	private final Mode mode = org.pepstock.coderba.client.modes.Stex.MODE;

	public static final LaTeX LANGUAGE = new LaTeX();

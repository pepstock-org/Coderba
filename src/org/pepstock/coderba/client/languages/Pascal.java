...
/**
 * Is the "Pascal" language entity in order to abe able to set to the editor.
 * 
...
public class Pascal implements Language {
	...
	private final String name = "text/x-pascal";

	private final String longName = "Pascal";

	private final Mode mode = org.pepstock.coderba.client.modes.Pascal.MODE;

	public static final Pascal LANGUAGE = new Pascal();

...
/**
 * Is the "Julia" language entity in order to abe able to set to the editor.
 * 
...
public class Julia implements Language {
	...
	private final String name = "text/x-julia";

	private final String longName = "Julia";

	private final Mode mode = org.pepstock.coderba.client.modes.Julia.MODE;

	public static final Julia LANGUAGE = new Julia();

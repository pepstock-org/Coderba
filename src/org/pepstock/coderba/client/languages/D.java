...
/**
 * Is the "D" language entity in order to abe able to set to the editor.
 * 
...
public class D implements Language {
	...
	private final String name = "text/x-d";

	private final String longName = "D";

	private final Mode mode = org.pepstock.coderba.client.modes.D.MODE;

	public static final D LANGUAGE = new D();

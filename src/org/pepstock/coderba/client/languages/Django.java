 ...
 *
 */
public class Django implements Language {

	private final String name = "text/x-django";

	private final String longName = "Django";

	private final Mode mode = org.pepstock.coderba.client.modes.Django.MODE;

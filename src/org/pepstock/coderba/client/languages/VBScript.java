 ...
 *
 */
public class VBScript implements Language {

	private final String name = "text/vbscript";

	private final String longName = "VBScript";

	private final Mode mode = org.pepstock.coderba.client.modes.Vbscript.MODE;

...
/**
 * Is the "Fortran" language entity in order to abe able to set to the editor.
 * 
...
public class Fortran implements Language {
	...
	private final String name = "text/x-fortran";

	private final String longName = "Fortran";

	private final Mode mode = org.pepstock.coderba.client.modes.Fortran.MODE;

	public static final Fortran LANGUAGE = new Fortran();

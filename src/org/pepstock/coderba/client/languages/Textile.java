 ...
 *
 */
public class Textile implements Language {

	private final String name = "text/x-textile";

	private final String longName = "Textile";

	private final Mode mode = org.pepstock.coderba.client.modes.Textile.MODE;

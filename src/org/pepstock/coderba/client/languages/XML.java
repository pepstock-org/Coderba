...
/**
 * Is the "XML" language entity in order to abe able to set to the editor.
 * 
...
public class XML implements Language {
	...
	private final String name = "application/xml ";

	private final String longName = "XML";

	private final Mode mode = org.pepstock.coderba.client.modes.Xml.MODE;

	public static final XML LANGUAGE = new XML();

...
/**
 * Is the "Pig" language entity in order to abe able to set to the editor.
 * 
...
public class Pig implements Language {
	...
	private final String name = "text/x-pig";

	private final String longName = "Pig";

	private final Mode mode = org.pepstock.coderba.client.modes.Pig.MODE;

	public static final Pig LANGUAGE = new Pig();

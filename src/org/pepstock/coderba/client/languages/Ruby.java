...
/**
 * Is the "Ruby" language entity in order to abe able to set to the editor.
 * 
...
public class Ruby implements Language {
	...
	private final String name = "text/x-ruby";

	private final String longName = "Ruby";

	private final Mode mode = org.pepstock.coderba.client.modes.Ruby.MODE;

	public static final Ruby LANGUAGE = new Ruby();

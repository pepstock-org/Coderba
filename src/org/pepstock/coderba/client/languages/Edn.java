...
/**
 * Is the "edn" language entity in order to abe able to set to the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Edn extends Language{

	private static final String NAME = "application/edn";

	private static final String LONG_NAME = "edn";

	private static final Mode MODE = ModeClojure.MODE;

	public static final Edn LANGUAGE = new Edn();

...
/**
 * Is the "Clojure" language entity in order to abe able to set to the editor.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class Clojure extends Language {

	private static final String NAME = "text/x-clojure";

	private static final String LONG_NAME = "Clojure";

	private static final Mode MODE = ModeClojure.MODE;

	public static final Clojure LANGUAGE = new Clojure();

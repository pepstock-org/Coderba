...
/**
 * Is the "Squirrel" language entity in order to abe able to set to the editor.
 * 
...
public final class Squirrel extends Language {
	...
	private static final String LONG_NAME = "Squirrel";

	private static final Mode MODE = ModeClike.MODE;

	public static final Squirrel LANGUAGE = new Squirrel();

...
import org.pepstock.coderba.client.modes.ModeMllike;

/**
 * Is the "OCaml" language entity in order to abe able to set to the editor.
 * 
...
public final class OCaml extends Language{
	...
	private static final String LONG_NAME = "OCaml";

	private static final Mode MODE = ModeMllike.MODE;

	public static final OCaml LANGUAGE = new OCaml();

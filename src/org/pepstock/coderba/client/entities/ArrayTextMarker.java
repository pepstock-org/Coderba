...
final class ArrayTextMarker extends Array {
	 ...
	 */
	native ArrayTextMarker slice(int start, int end);
	 ...
	 */
	native ArrayTextMarker splice(int start);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayTextMarker splice(int start, int deleteCounts);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayTextMarker splice(int start, int deleteCounts, NativeTextMarker item);
	 ...
	 */
	@JsOverlay
	NativeTextMarker remove(int index) {
	 ...
	 */
	@JsOverlay
	void insertAt(int index, NativeTextMarker item) {
		splice(index, 0, item);
	}
	 ...
	 */
	native void fill(NativeTextMarker item, int start, int end);
	 ...
	 */
	native void push(NativeTextMarker item);
	 ...
	 */
	@JsOverlay
	void set(int index, NativeTextMarker item) {

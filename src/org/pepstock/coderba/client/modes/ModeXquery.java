...
/**
 * Is the "xquery" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeXquery extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeXquery MODE = new ModeXquery();
	...
	private ModeXquery() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.xquery()));
	}
}

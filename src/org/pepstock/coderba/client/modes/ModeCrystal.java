...
/**
 * Is the "crystal" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeCrystal extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeCrystal MODE = new ModeCrystal();
	...
	private ModeCrystal() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.crystal()));
	}
}

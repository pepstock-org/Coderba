...
/**
 * Is the "turtle" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeTurtle extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeTurtle MODE = new ModeTurtle();
	...
	private ModeTurtle() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.turtle()));
	}
}

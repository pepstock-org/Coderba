...
/**
 * Is the "perl" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePerl extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePerl MODE = new ModePerl();
	...
	private ModePerl() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.perl()));
	}
}

...
/**
 * Is the "http" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeHttp extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeHttp MODE = new ModeHttp();
	...
	private ModeHttp() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.http()));
	}
}

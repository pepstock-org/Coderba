...
/**
 * Is the "toml" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeToml extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeToml MODE = new ModeToml();
	...
	private ModeToml() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.toml()));
	}
}

...
/**
 * Is the "clojure" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeClojure extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeClojure MODE = new ModeClojure();
	...
	private ModeClojure() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.clojure()));
	}
}

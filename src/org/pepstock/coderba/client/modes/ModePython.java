...
/**
 * Is the "python" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePython extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePython MODE = new ModePython();
	...
	private ModePython() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.python()));
	}
}

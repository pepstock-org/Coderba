...
/**
 * Is the "erlang" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeErlang extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeErlang MODE = new ModeErlang();
	...
	private ModeErlang() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.erlang()));
	}
}

...
/**
 * Is the "css" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeCss extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeCss MODE = new ModeCss();
	...
	private ModeCss() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.css()));
	}
}

...
/**
 * Is the "q" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeQ extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeQ MODE = new ModeQ();
	...
	private ModeQ() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.q()));
	}
}

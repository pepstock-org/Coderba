...
/**
 * Is the "protobuf" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeProtobuf extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeProtobuf MODE = new ModeProtobuf();

	/**
	 * To avoid any instantiation
	 */
	private ModeProtobuf() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.protobuf()));
	}
}

...
/**
 * Is the "diff" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeDiff extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeDiff MODE = new ModeDiff();
	...
	private ModeDiff() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.diff()));
	}
}

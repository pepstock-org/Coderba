...
/**
 * Is the "tornado" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeTornado extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeTornado MODE = new ModeTornado();
	...
	private ModeTornado() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.tornado()));
	}
}

...
/**
 * Is the "powershell" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePowershell extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePowershell MODE = new ModePowershell();

	/**
	 * To avoid any instantiation
	 */
	private ModePowershell() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.powershell()));
	}
}

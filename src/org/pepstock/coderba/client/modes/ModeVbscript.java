...
/**
 * Is the "vbscript" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeVbscript extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeVbscript MODE = new ModeVbscript();

	/**
	 * To avoid any instantiation
	 */
	private ModeVbscript() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.vbscript()));
	}
}

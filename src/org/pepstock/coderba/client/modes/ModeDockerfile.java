...
/**
 * Is the "dockerfile" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeDockerfile extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeDockerfile MODE = new ModeDockerfile();

	/**
	 * To avoid any instantiation
	 */
	private ModeDockerfile() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.dockerfile()));
	}
}

...
/**
 * Is the "fortran" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeFortran extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeFortran MODE = new ModeFortran();
	...
	private ModeFortran() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.fortran()));
	}
}

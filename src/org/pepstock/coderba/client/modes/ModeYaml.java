...
/**
 * Is the "yaml" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeYaml extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeYaml MODE = new ModeYaml();
	...
	private ModeYaml() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.yaml()));
	}
}

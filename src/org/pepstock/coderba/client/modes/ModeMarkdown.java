...
/**
 * Is the "markdown" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeMarkdown extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeMarkdown MODE = new ModeMarkdown();

	/**
	 * To avoid any instantiation
	 */
	private ModeMarkdown() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.markdown()));
	}
}

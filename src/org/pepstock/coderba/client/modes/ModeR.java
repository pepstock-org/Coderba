...
/**
 * Is the "r" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeR extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeR MODE = new ModeR();
	...
	private ModeR() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.r()));
	}
}

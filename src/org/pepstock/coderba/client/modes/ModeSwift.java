...
/**
 * Is the "swift" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSwift extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSwift MODE = new ModeSwift();
	...
	private ModeSwift() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.swift()));
	}
}

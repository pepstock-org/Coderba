...
/**
 * Is the "pascal" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePascal extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePascal MODE = new ModePascal();
	...
	private ModePascal() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.pascal()));
	}
}

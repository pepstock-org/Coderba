...
/**
 * Is the "haml" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeHaml extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeHaml MODE = new ModeHaml();
	...
	private ModeHaml() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.haml()));
	}
}

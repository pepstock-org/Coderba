...
/**
 * Is the "spreadsheet" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSpreadsheet extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSpreadsheet MODE = new ModeSpreadsheet();

	/**
	 * To avoid any instantiation
	 */
	private ModeSpreadsheet() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.spreadsheet()));
	}
}

...
/**
 * Is the "pig" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePig extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePig MODE = new ModePig();
	...
	private ModePig() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.pig()));
	}
}

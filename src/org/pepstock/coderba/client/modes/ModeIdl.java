...
/**
 * Is the "idl" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeIdl extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeIdl MODE = new ModeIdl();
	...
	private ModeIdl() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.idl()));
	}
}

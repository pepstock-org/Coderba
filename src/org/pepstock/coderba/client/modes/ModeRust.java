...
/**
 * Is the "rust" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeRust extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeRust MODE = new ModeRust();
	...
	private ModeRust() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.rust()));
	}
}

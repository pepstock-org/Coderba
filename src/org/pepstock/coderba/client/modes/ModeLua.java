...
/**
 * Is the "lua" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeLua extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeLua MODE = new ModeLua();
	...
	private ModeLua() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.lua()));
	}
}

...
/**
 * Is the "eiffel" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeEiffel extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeEiffel MODE = new ModeEiffel();
	...
	private ModeEiffel() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.eiffel()));
	}
}

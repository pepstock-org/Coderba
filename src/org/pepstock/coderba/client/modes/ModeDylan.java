...
/**
 * Is the "dylan" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeDylan extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeDylan MODE = new ModeDylan();
	...
	private ModeDylan() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.dylan()));
	}
}

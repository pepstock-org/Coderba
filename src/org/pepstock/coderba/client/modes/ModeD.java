...
/**
 * Is the "d" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeD extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeD MODE = new ModeD();
	...
	private ModeD() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.d()));
	}
}

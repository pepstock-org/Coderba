...
/**
 * Is the "xml" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeXml extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeXml MODE = new ModeXml();
	...
	private ModeXml() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.xml()));
	}
}

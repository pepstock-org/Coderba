...
/**
 * Is the "shell" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeShell extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeShell MODE = new ModeShell();
	...
	private ModeShell() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.shell()));
	}
}

...
/**
 * Is the "mirc" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeMirc extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeMirc MODE = new ModeMirc();
	...
	private ModeMirc() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.mirc()));
	}
}

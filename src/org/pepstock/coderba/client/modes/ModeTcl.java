...
/**
 * Is the "tcl" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeTcl extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeTcl MODE = new ModeTcl();
	...
	private ModeTcl() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.tcl()));
	}
}

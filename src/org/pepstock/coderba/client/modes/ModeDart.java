...
/**
 * Is the "dart" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeDart extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeDart MODE = new ModeDart();
	...
	private ModeDart() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.dart()));
	}
}

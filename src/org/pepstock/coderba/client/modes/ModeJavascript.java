...
/**
 * Is the "javascript" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeJavascript extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeJavascript MODE = new ModeJavascript();

	/**
	 * To avoid any instantiation
	 */
	private ModeJavascript() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.javascript()));
	}
}

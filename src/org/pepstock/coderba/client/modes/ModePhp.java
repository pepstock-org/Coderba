...
/**
 * Is the "php" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModePhp extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModePhp MODE = new ModePhp();
	...
	private ModePhp() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.php()));
	}
}

...
/**
 * Is the "solr" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSolr extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSolr MODE = new ModeSolr();
	...
	private ModeSolr() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.solr()));
	}
}

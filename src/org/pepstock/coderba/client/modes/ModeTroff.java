...
/**
 * Is the "troff" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeTroff extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeTroff MODE = new ModeTroff();
	...
	private ModeTroff() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.troff()));
	}
}

...
/**
 * Is the "julia" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeJulia extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeJulia MODE = new ModeJulia();
	...
	private ModeJulia() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.julia()));
	}
}

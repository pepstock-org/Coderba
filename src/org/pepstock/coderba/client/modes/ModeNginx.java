...
/**
 * Is the "nginx" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeNginx extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeNginx MODE = new ModeNginx();
	...
	private ModeNginx() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.nginx()));
	}
}

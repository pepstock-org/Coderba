...
/**
 * Is the "sas" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSas extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSas MODE = new ModeSas();
	...
	private ModeSas() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.sas()));
	}
}

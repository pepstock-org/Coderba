...
/**
 * Is the "velocity" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeVelocity extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeVelocity MODE = new ModeVelocity();

	/**
	 * To avoid any instantiation
	 */
	private ModeVelocity() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.velocity()));
	}
}

...
/**
 * Is the "cmake" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeCmake extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeCmake MODE = new ModeCmake();
	...
	private ModeCmake() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.cmake()));
	}
}

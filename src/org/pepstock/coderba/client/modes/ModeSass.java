...
/**
 * Is the "sass" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSass extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSass MODE = new ModeSass();
	...
	private ModeSass() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.sass()));
	}
}

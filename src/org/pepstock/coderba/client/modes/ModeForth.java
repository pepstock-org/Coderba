...
/**
 * Is the "forth" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeForth extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeForth MODE = new ModeForth();
	...
	private ModeForth() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.forth()));
	}
}

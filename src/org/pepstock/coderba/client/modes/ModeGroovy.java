...
/**
 * Is the "groovy" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeGroovy extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeGroovy MODE = new ModeGroovy();
	...
	private ModeGroovy() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.groovy()));
	}
}

...
/**
 * Is the "ruby" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeRuby extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeRuby MODE = new ModeRuby();
	...
	private ModeRuby() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.ruby()));
	}
}

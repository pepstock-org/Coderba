...
/**
 * Is the "sparql" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSparql extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSparql MODE = new ModeSparql();
	...
	private ModeSparql() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.sparql()));
	}
}

...
/**
 * Is the "sql" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeSql extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeSql MODE = new ModeSql();
	...
	private ModeSql() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.sql()));
	}
}

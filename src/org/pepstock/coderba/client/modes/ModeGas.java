...
/**
 * Is the "gas" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeGas extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeGas MODE = new ModeGas();
	...
	private ModeGas() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.gas()));
	}
}

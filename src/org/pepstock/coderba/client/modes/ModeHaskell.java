...
/**
 * Is the "haskell" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeHaskell extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeHaskell MODE = new ModeHaskell();
	...
	private ModeHaskell() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.haskell()));
	}
}

...
/**
 * Is the "properties" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeProperties extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeProperties MODE = new ModeProperties();

	/**
	 * To avoid any instantiation
	 */
	private ModeProperties() {
		// passes the name of mode
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.properties()));
	}
}

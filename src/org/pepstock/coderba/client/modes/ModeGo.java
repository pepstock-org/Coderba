...
/**
 * Is the "go" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeGo extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeGo MODE = new ModeGo();
	...
	private ModeGo() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.go()));
	}
}

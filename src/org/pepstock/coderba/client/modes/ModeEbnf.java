...
/**
 * Is the "ebnf" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeEbnf extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeEbnf MODE = new ModeEbnf();
	...
	private ModeEbnf() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.ebnf()));
	}
}

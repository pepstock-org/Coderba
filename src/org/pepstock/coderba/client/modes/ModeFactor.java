...
/**
 * Is the "factor" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeFactor extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeFactor MODE = new ModeFactor();
	...
	private ModeFactor() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.factor()));
	}
}

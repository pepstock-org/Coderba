...
/**
 * Is the "twig" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeTwig extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeTwig MODE = new ModeTwig();
	...
	private ModeTwig() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.twig()));
	}
}

...
/**
 * Is the "stylus" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeStylus extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeStylus MODE = new ModeStylus();
	...
	private ModeStylus() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.stylus()));
	}
}

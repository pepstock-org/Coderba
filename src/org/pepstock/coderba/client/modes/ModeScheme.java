...
/**
 * Is the "scheme" mode to enable the editor to manage this programming language.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ModeScheme extends Mode {
	// name of editor mode
	 ...
	 */
	public static final ModeScheme MODE = new ModeScheme();
	...
	private ModeScheme() {
		...
		super(NAME);
		getResources().add(new ScriptResource(ModeResources.INSTANCE.scheme()));
	}
}

...
/**
 * Is the "eclipse"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeEclipse extends Theme {
	 ...
	 */
	public static final ThemeEclipse THEME = new ThemeEclipse();

	/**
	 * To avoid any instantiation
	 */
	private ThemeEclipse() {
		// passes the name of theme
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.eclipse()));
	}

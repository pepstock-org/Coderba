...
/**
 * Is the "nord" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeNord extends Theme {
	// name of editor theme
	private static final String NAME = "nord";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeNord THEME = new ThemeNord();
	...
	private ThemeNord() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.nord()));
	}

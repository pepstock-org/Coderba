...
/**
 * Is the "darcula"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeDarcula extends Theme {
	 ...
	 */
	public static final ThemeDarcula THEME = new ThemeDarcula();

	/**
	 * To avoid any instantiation
	 */
	private ThemeDarcula() {
		// passes the name of theme
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.darcula()));
	}

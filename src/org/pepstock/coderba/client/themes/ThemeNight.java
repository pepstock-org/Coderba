...
/**
 * Is the "night" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeNight extends Theme {
	 ...
	 */
	public static final ThemeNight THEME = new ThemeNight();
	...
	private ThemeNight() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.night()));
	}

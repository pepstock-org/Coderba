...
/**
 * Is the "abcdef" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeAbcdef extends Theme {
	 ...
	 */
	public static final ThemeAbcdef THEME = new ThemeAbcdef();
	...
	private ThemeAbcdef() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.abcdef()));
	}

...
/**
 * Is the "cobalt"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeCobalt extends Theme {
	// name of editor theme
	private static final String NAME = "cobalt";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeCobalt THEME = new ThemeCobalt();
	...
	private ThemeCobalt() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.cobalt()));
	}

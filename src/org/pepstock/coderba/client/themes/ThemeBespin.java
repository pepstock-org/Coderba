...
/**
 * Is the "bespin" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeBespin extends Theme {
	 ...
	 */
	public static final ThemeBespin THEME = new ThemeBespin();
	...
	private ThemeBespin() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.bespin()));
	}

...
/**
 * Is the "xq-dark" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeXqDark extends Theme {
	// name of editor theme
	private static final String NAME = "xq-dark";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeXqDark THEME = new ThemeXqDark();
	...
	private ThemeXqDark() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.xqDark()));
	}

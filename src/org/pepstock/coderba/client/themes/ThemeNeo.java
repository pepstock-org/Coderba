...
/**
 * Is the "neo" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeNeo extends Theme {
	// name of editor theme
	private static final String NAME = "neo";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeNeo THEME = new ThemeNeo();
	...
	private ThemeNeo() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.neo()));
	}

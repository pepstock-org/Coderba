...
/**
 * Is the "yonce" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeYonce extends Theme {
	// name of editor theme
	private static final String NAME = "yonce";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeYonce THEME = new ThemeYonce();
	...
	private ThemeYonce() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.yonce()));
	}

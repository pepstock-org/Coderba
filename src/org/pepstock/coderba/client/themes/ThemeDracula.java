...
/**
 * Is the "dracula"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeDracula extends Theme {
	 ...
	 */
	public static final ThemeDracula THEME = new ThemeDracula();

	/**
	 * To avoid any instantiation
	 */
	private ThemeDracula() {
		// passes the name of theme
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.dracula()));
	}

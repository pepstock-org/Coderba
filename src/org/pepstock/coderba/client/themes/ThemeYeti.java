...
/**
 * Is the "yeti"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeYeti extends Theme {
	// name of editor theme
	private static final String NAME = "yeti";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeYeti THEME = new ThemeYeti();
	...
	private ThemeYeti() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.yeti()));
	}

...
/**
 * Is the "ttcn" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeTtcn extends Theme {
	 ...
	 */
	public static final ThemeTtcn THEME = new ThemeTtcn();
	...
	private ThemeTtcn() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.ttcn()));
	}

 ...
 *
 */
public final class ThemeVibrantInk extends Theme {
	// name of editor theme
	private static final String NAME = "vibrant-ink";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeVibrantInk THEME = new ThemeVibrantInk();

	/**
	 * To avoid any instantiation
	 */
	private ThemeVibrantInk() {
		// passes the name of theme
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.vibrantInk()));
	}

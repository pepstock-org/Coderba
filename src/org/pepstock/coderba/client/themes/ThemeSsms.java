...
/**
 * Is the "ssms" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeSsms extends Theme {
	// name of editor theme
	private static final String NAME = "ssms";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeSsms THEME = new ThemeSsms();
	...
	private ThemeSsms() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.ssms()));
	}

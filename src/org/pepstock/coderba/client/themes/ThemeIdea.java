...
/**
 * Is the "idea" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeIdea extends Theme {
	 ...
	 */
	public static final ThemeIdea THEME = new ThemeIdea();
	...
	private ThemeIdea() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.idea()));
	}

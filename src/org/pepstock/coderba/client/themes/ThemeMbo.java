...
/**
 * Is the "mbo"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeMbo extends Theme {
	// name of editor theme
	private static final String NAME = "mbo";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeMbo THEME = new ThemeMbo();
	...
	private ThemeMbo() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.mbo()));
	}

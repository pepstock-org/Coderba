...
/**
 * Is the "neat"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeNeat extends Theme {
	// name of editor theme
	private static final String NAME = "neat";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeNeat THEME = new ThemeNeat();
	...
	private ThemeNeat() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.neat()));
	}

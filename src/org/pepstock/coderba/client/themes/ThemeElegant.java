...
/**
 * Is the "elegant"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeElegant extends Theme {
	// name of editor theme
	private static final String NAME = "elegant";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeElegant THEME = new ThemeElegant();
	...
	private ThemeElegant() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.elegant()));
	}

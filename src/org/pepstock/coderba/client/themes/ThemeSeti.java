...
/**
 * Is the "seti" theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeSeti extends Theme {
	// name of editor theme
	private static final String NAME = "seti";

	/**
	 * Instance of editor theme.
	 */
	public static final ThemeSeti THEME = new ThemeSeti();
	...
	private ThemeSeti() {
		...
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.seti()));
	}

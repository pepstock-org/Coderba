...
/**
 * Is the "material"  theme to enable the editor to apply the theme.
 * 
 * @author Andrea "Stock" Stocchero
 *
 */
public final class ThemeMaterial extends Theme {
	 ...
	 */
	public static final ThemeMaterial THEME = new ThemeMaterial();

	/**
	 * To avoid any instantiation
	 */
	private ThemeMaterial() {
		// passes the name of theme
		super(NAME);
		getResources().add(new StyleResource(ThemeResources.INSTANCE.material()));
	}

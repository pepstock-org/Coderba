 ...
 * This implementation uses a java script array as back-end to store objects (entities).
 * 
 * @author Andrea "Stock" Stocchero
 * 
 */
public final class ArrayEntityList<T extends NativeEntity> extends AbstractArrayList<T, ArrayEntity<T>> {

	// delegated array to store objects
	private final ArrayEntity<T> array;
	...
	public boolean retainAll(Collection<?> collection) {
		...
		if (modified) {
			...
			List<T> contained = new ArrayList<>();

...
public final class ArrayHistoryChangeItem extends Array {

	/**
	 * To avoid any instantiation
	 */
	ArrayHistoryChangeItem() {
	}
	 ...
	 */
	native ArrayHistoryChangeItem slice(int start, int end);
	 ...
	 */
	native ArrayHistoryChangeItem splice(int start);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayHistoryChangeItem splice(int start, int deleteCounts);
	 ...
	 *         If no elements are removed, an empty array is returned.
	 */
	native ArrayHistoryChangeItem splice(int start, int deleteCounts, HistoryChangeItem item);
	 ...
	 */
	@JsOverlay
	HistoryChangeItem remove(int index) {
	 ...
	 */
	@JsOverlay
	void insertAt(int index, HistoryChangeItem item) {
		splice(index, 0, item);
	}
	 ...
	 */
	native void fill(HistoryChangeItem item, int start, int end);
	 ...
	 */
	native void push(HistoryChangeItem item);
	 ...
	 */
	@JsOverlay
	void set(int index, HistoryChangeItem item) {

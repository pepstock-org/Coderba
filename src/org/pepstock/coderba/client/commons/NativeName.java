...
public final class NativeName {
	...
	/**
	 * Constant to bind java script object as CodeMirror with name <b>{@value CODE_MIRROR}</b>, (internal of CodeMirror).
	 */
	public static final String CODE_MIRROR = "CodeMirror";

	/**
	 * Constant to bind java script object as CodeMirror document with name <b>{@value DOCUMENT}</b>, (internal of CodeMirror).
	 */
